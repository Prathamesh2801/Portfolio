import { Facebook, Instagram, Linkedin, MapPin, Mail, Phone, DribbbleIcon as BehanceLogo, Github } from 'lucide-react'
  ...
  return (
    <section className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#0f1630] via-[#1a2744] to-[#3d5180]">
      ...
      <div className="container mx-auto px-6 py-20">
        <h1 className="text-4xl font-bold text-center text-white mb-16">CONTACT</h1>
        ...
        {/* Footer */}
        <div className="mt-20 flex flex-col md:flex-row justify-between items-center text-white">
          <p>2024 - Prathamesh Kamble , All rights reserved</p>
          <div className="flex gap-4 mt-4 md:mt-0">
            
            <a href="https://www.linkedin.com/in/prathamesh-kamble-51b8502a5/" target='_blank' className="w-12 h-12 bg-blue-600/30 rounded-lg flex items-center justify-center hover:bg-blue-600/50 transition-colors">
              <Linkedin className="w-6 h-6" />
            </a>
            <a href="https://github.com/Prathamesh2801" target='_blank' className="w-12 h-12 bg-blue-600/30 rounded-lg flex items-center justify-center hover:bg-blue-600/50 transition-colors">
